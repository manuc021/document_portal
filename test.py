...
def test_compare_documents():
    ref_path = Path("D:\\AI-ML\\llm_ops_krish\\document_portal\\data\document_compare\\Long_Report_V1.pdf")
    act_path = Path("D:\\AI-ML\\llm_ops_krish\\document_portal\\data\document_compare\\Long_Report_V1.pdf")
